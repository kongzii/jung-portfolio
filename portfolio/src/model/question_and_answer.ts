...
import type { Token } from './bert_tokenizer';
...
class QuestionAndAnswerImpl implements QuestionAndAnswer {
  ...
  constructor(private modelConfig: ModelConfig | null) {
...
export async function load(modelConfig: ModelConfig | null = null):
